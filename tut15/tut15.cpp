...
static void InitializeGlutCallbacks()
{
    ...
    glutSpecialFunc(SpecialKeyboardCB);//функция обратного вызова для нажатия специальных клавиш
    glutPassiveMotionFunc(PassiveMouseCB);//функция обратного вызова для мыши
    glutKeyboardFunc(KeyboardCB);//функция обратного вызова для нажатия клавиш
}
...
int main(int argc, char** argv)
{
    ...
    glutEnterGameMode();// разрешает приложению запускаться в полноэкранном режиме
